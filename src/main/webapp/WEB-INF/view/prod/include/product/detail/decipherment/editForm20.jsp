<div class="ui modal decipherment_edit_form20__modal">
    ...
    <div class="content">
        <form class="ui form">
            ...
            <div class="field inline required">
                <label>Рентабельность (первый индекс) %</label>
                <div class="ui fluid">
                    <input name="profitabilityFirst" class="prompt" type="text" value="${profitabilityFirst}">
                </div>
            </div>
            <div class="field inline required">
                <label>Рентабельность (второй индекс) %</label>
                <div class="ui fluid">
                    <input name="profitabilitySecond" class="prompt" type="text" value="${profitabilitySecond}">
                </div>
            </div>
...
<script>
    $(() => {
        const $modal = $('div.decipherment_edit_form20__modal');
        const $inputs = $modal.find('input[name="profitabilityFirst"], input[name="profitabilitySecond"]');
