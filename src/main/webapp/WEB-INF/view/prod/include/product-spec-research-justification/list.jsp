<div class="list__header">
    <h1 class="list__header_title">Цены на СИ</h1>
...
<script>
    $(() => {
        ...
        function deleteJustification(id) {
            confirmDialog({
                title: 'Удаление обоснования цен на СП',
                message: 'Вы действительно хотите удалить обоснование цен на СП?',
                onAccept: () => $.ajax({
                    method: 'DELETE',
        ...
        // Отображение цен
        function showGroupPrice(id) {
            $subContent.html('');
            $subBlock.show();
            setTimeout(() => table.scrollToRow(id, 'middle', false), 200);
            $.get({
                url: VIEW_PATH.LIST_GROUP_PRICE,
                data: { id: id }
