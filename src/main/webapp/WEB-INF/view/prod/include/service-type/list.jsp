<div class="list__header">
    <h1 class="list__header_title">Типы услуг</h1>
    ...
    $(() => {
        ...
        const table = new Tabulator('div.list__table', {
            ...
            columns: [
                ...
                TABR_COL_ID,
                { title: 'Наименование услуги', field: TABR_FIELD.NAME },
                { title: 'Префикс', field: TABR_FIELD.PREFIX },
                {
                    title: 'Комментарий',
        ...
        // Редактирование/добавление типа услуги
        ...
        function deleteType(id) {
            confirmDialog({
                ...
                message: 'Вы действительно хотите удалить тип услуги?',
                onAccept: () => $.ajax({
                    method: 'DELETE',
