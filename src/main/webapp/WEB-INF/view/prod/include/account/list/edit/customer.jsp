<div class="ui modal list_edit_customer__main">
    ...
    <div class="scrolling content">
        <div class="list_edit_customer__header_buttons">
            <i class="icon filter link blue list_edit_customer__btn-filter" title="<fmt:message key="label.button.filter"/>"></i>
        </div>
...
<script>
    $(() => {
        ...
        const $addBtn = $parentEditModal.find('.list_edit_customer__btn-add');
