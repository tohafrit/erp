<div class="list__container">
    <div class="list__header">
        <h1 class="list__header_title">Государственные контракты</h1>
    ...
    <script>
        $(() => {
            ...
            // Удаление госконтракта
            function deleteContract(id) {
                confirmDialog({
                    title: 'Удаление госконтракта',
                    message: 'Вы действительно хотите удалить госконтракт?',
                    onAccept: () => $.ajax({
                        method: 'DELETE',
