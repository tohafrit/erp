...
import ru.korundm.repository.ProductSpecResearchJustificationRepository
...
interface ProductSpecResearchJustificationService : CommonService<ProductSpecResearchJustification> {
    ...
    fun getLastApproved(): ProductSpecResearchJustification?
}

@Service
@Transactional
class ProductSpecResearchJustificationServiceImpl(
    private val repository: ProductSpecResearchJustificationRepository
) : ProductSpecResearchJustificationService {

    private val cl = ProductSpecResearchJustification::class.java

    @PersistenceContext
    private lateinit var em: EntityManager

    override fun getAll(): List<ProductSpecResearchJustification> = repository.findAll()

    override fun getAllById(idList: List<Long>): List<ProductSpecResearchJustification> = repository.findAllById(idList)

    override fun save(obj: ProductSpecResearchJustification): ProductSpecResearchJustification {
        em.detach(obj)
        return repository.save(obj)
    }

    override fun saveAll(objectList: List<ProductSpecResearchJustification>): List<ProductSpecResearchJustification> = repository.saveAll(objectList)

    override fun read(id: Long): ProductSpecResearchJustification? = repository.findById(id).orElse(null)

    override fun delete(obj: ProductSpecResearchJustification) = repository.delete(obj)
    ...
    override fun <T : RowCountable> findTableData(
        ...
        val query = """
            ...
            FROM
                product_spec_research_justification psrj
            WHERE
    ...
    override fun <T : RowCountable> findDeciphermentTableData(
        ...
        val query = """
            ...
            FROM
                product_spec_research_justification psrj
                LEFT JOIN
                product_spec_research_price psrp
