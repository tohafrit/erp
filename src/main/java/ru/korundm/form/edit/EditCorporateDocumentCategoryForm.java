...
@Getter
@Setter
public class EditCorporateDocumentCategoryForm implements Validatable {

    private Long id; // идентификатор
    private String name; // наименование
    private String description; // описание
    private int sort = 500; // сортировка
    private CorporateDocumentCategory parent; // категория-родитель
